...
3. Click **Load unpacked** and pick this `extensions/chrome-firefox/` folder.
4. Open reddit.com (logged in): the **Reddirama** button appears bottom-right.

**Firefox (142+):**
1. Open `about:debugging#/runtime/this-firefox`.
2. Click **Load Temporary Add-on** and pick `extensions/chrome-firefox/manifest.json`.
3. Open reddit.com (logged in). Temporary add-ons are removed when Firefox restarts.

## Publish (optional)

- **Chrome Web Store:** zip the contents of `extensions/chrome-firefox/`, upload on the
